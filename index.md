...
helper: ["Kelsey Florek MPH PhD", "Eva Gunawan MS", "Dustin Lyfong MS", "Madeline Topf PhD"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
{% endcomment %}
<p>
  If you haven't used Zoom before, you can go to the
